...
def create_sample_data():
    ...
    y = (X[:, 0] + X[:, 1] * 2 > 0).astype(int)  # Binary classification
...
def train_and_save_models():
    ...
    # 1. Train Random Forest (sklearn) and save as .pkl
    print("="*50)
    ...
    # 2. Train Neural Network (Keras) and save as .keras
    print("\n" + "="*50)
    print("Training Neural Network model...")
    print("="*50)
    
    # Using Input layer (Modern approach)
